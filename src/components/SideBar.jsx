...
import { RiMenu3Line, RiCloseLine, RiRadio2Fill } from "react-icons/ri";
    ...
    <>
      <div className="flex-col hidden gap-[50px] w-[5%] mt-[15px] lg:block">
        <div className="hidden flex-row lg:block">
          <img src={logo} alt="logo" className="w-[38px] ml-[30%] h-14 object-contain" />
        </div>
        <div className="md:flex flex-col w-[52px] h-[270px] rounded-[32px] ml-5 bg-[#1A1E1F] items-center justify-center gap-[5px]">
          ...
          <NavLink to="/Library">
            <SiApplemusic
              className={`w-[29px] h-14  ${pathname === "/Library" ? "home" : ""}`}
              id="logout"
            />
          </NavLink>
        ...
        <div className="md:flex flex-col w-[52px] h-[127px] rounded-[32px] ml-5 bg-[#1A1E1F] items-center justify-center gap-[5px]">
          <NavLink to="/profile/signup">
            <BsPersonFill
              className={`w-[32px] h-14 ${
                pathname === "/profile/signup" || pathname === "/profile/login" ? "home" : ""
              }`}
              id="logout"
            />
          </NavLink>

          <IoMdLogOut className="w-[32px] h-14" id="logout" onClick={logOut} />
        </div>
      </div>
            ...
            <nav className="lg:hidden flex flex-col bg-darkblue-secondary mt-[30px] top-0 w-full justify-center text-white">
              ...
              <div className="text-white text-2xl">
                <NavLink to="/" className="flex flex-row items-center gap-[15px]">
                  <AiFillHome
                    className={`w-[32px] h-14 ${
                      pathname === "/" ? "home" : "" || pathname === "/Album/:i" ? "home" : ""
                    }`}
                    id="logout"
                  />
                  Home
              ...
              <div className="text-white text-2xl">
                <NavLink to="/Library" className="flex flex-row items-center gap-[15px]">
                  <SiApplemusic
                    className={`w-[29px] h-14  ${pathname === "/Library" ? "home" : ""}`}
                    id="logout"
                  />
